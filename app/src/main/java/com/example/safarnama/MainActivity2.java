        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (signUpEmailTextInput.getText().toString().contentEquals("")) {
                    ...
                    mAuth.createUserWithEmailAndPassword(signUpEmailTextInput.getText().toString(), signUpPasswordTextInput.getText().toString()).addOnCompleteListener(    MainActivity2.this, new OnCompleteListener<AuthResult>() {
                        @Override
                                                            ...
                                                            alertDialogBuilder
                                                                    ...
                                                                    .setPositiveButton("Sign In", new DialogInterface.OnClickListener() {
                                                                        public void onClick(DialogInterface dialog, int id) {
                                                                            ...
                                                                            Intent signInIntent = new Intent(MainActivity2.this, MainActivity.class);
