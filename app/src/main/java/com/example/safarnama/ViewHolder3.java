...
public class ViewHolder3 extends RecyclerView.Adapter<ViewHolder3.MyViewHolder> {
    //create a list to pass our Model class
    List<Model3> modelList2;
    Context context;
    public ViewHolder3(List<Model3> modelList2, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_custom4,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        final Model3 model = modelList2.get(position);
