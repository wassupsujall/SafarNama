...
public class ViewHolder1 extends RecyclerView.Adapter<ViewHolder1.MyViewHolder> {
    //create a list to pass our Model class
    List<Model1> modelList1;
    Context context;
    public ViewHolder1(List<Model1> modelList1, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        final Model1 model = modelList1.get(position);
